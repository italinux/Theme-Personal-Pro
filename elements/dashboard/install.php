...
<div class="install_wrapper">
  ...
  <div class="clearfix cols_wrapper">
    <div class="col starting_point none active" style="background-color: #e4e8ec; color:#616161">
      <h3><?php echo t('No Content')?></h3>
    </div>
    <div class="col starting_point" style="background-color: #e3fee4; color:#616161">
