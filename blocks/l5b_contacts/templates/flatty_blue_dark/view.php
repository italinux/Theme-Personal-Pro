...
<section id="<?php echo $sID?>" class="<?php echo $cTemplate?> page-block pre-hand over-image <?php echo $cFgColorClass?> contacts">
  <div class="container-fluid <?php echo $disabled?>" id="<?php echo $viewPoint?>">
    ...
    <div class="row main">
      ...
      <div id="<?php echo $viewPoint?>-more" data-animation="others" class="others col-md-4">

      <?php 
        if (trim($telephone) == true) {
        ?>
        <div id="<?php echo $viewPoint?>-more-mobile" data-animation="other-mobile" class="col-md-12 col-sm-4">
          <div class="col-sx-12">
            <div class="col-md-8">
      ...
      <?php
        ...
        ?>
        <div id="<?php echo $viewPoint?>-more-address" data-animation="other-address" class="col-md-12 col-sm-4">
          <div class="col-sx-12">
            <div class="col-md-8">
      ...
      <?php
        ...
        ?>
        <div data-animation="other-facebook" class="col-md-12 col-sm-4">
          <div class="col-sx-12">
            <div class="col-md-8">
              <h4>Facebook:</h4>
            </div>
      ...
      <?php
        if (trim($email) == true) {
        ?>
        <div id="<?php echo $viewPoint?>-more-email" data-animation="other-email" class="col-md-12 col-sm-4">
          <div class="col-sx-12">
            <div class="col-md-8">
