...
class Controller extends BlockController
{
             ...
             'isEnabled' => true,
              'linkType' => 'url',
                ...
                'target' => 'self',
                 'icon'  => 'pencil',
                 'title' => t('paperbacks'),
               'content' => '<p>Crebritate tunica die et armatis eum et nihil muros <strong>mandato obscuro</strong> Polam prope celeri</p>',
           ...
           4 => array(
             'isEnabled' => false,
              'linkType' => 'url',
               ...
               'content' => '<p>Laeva successorio <strong>Euphratis dextra</strong> cum limes cognomentum regna porrigitur ut efficaciae</p>',
                'button' => t('check it out'),
           ),
           'CTA' => array(
              'linkType' => 'url',
    ...
    */
    ...
    public function on_start()
    {
        ...
        $al->register('javascript', $this->getJSelectorId() . '.animate-conf', 'blocks/l5b_what_i_do/jscript/lazy-animate.conf.js?t=' . $this->getSectionId(), $cf, 'theme_lazy5basic');
